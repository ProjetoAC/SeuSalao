    ...
    <body>
        <div class="top-menu">
            ...
            <nav class="menu">
                ...
                <ul>
                    <li><a href="configuracao.jsp"><i class="fa fa-cogs fa-2x components-menu"></i><font>Configurações</font></a></li>
                    <li><a href="abrir-caixa.jsp"><i class="fa fa-calculator fa-2x components-menu"></i><font>Abrir Caixa</font></a></li>
